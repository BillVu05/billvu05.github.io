...
* Built advanced Excel models for campaign and store performance reporting: **Power Query** ingestion and transformation, **pivot tables** for multi-dimensional breakdowns, **INDEX/MATCH and XLOOKUP** lookups across joined data sets, and **what-if scenario tables and Solver** for budget and target optimisation
